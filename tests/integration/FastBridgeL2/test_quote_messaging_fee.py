...
def test_quote_messaging_fee_consistency(forked_env, fast_bridge_l2):
    ...
    # Get multiple quotes
    fee1 = fast_bridge_l2.quote_messaging_fee()
    fee2 = fast_bridge_l2.quote_messaging_fee()
    fee3 = fast_bridge_l2.quote_messaging_fee()
...
def test_quote_messaging_fee_after_messenger_change(forked_env, fast_bridge_l2, dev_deployer):
    ...
    # Get initial fee
    initial_fee = fast_bridge_l2.quote_messaging_fee()
...
"""
    ...
    # Get new fee
    new_fee = fast_bridge_l2.quote_messaging_fee()
